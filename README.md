...
- **Next.js** on **Vercel**
- **JavaScript** + **CSS Modules** (no TypeScript, no Tailwind — by choice)
- Adding as projects need them: **Sanity**, **Neon + Prisma**, **Clerk**, **Resend**, **Plausible**
- Day-to-day in **Cursor** with **Claude Code**, on **WSL2 / Ubuntu**

### How I work

I'd rather ship something honest than something loud. The goal with client work is simple and measurable — a clean site, a real Google presence, and the phone actually ringing. I keep the marketing quiet and let the results carry it.

---

📫 **Reach me:** [arthursgroup.co](https://arthursgroup.co) · `your-email-here`
